...
- Intro paragraph 2 reframed active 2026-08-30 (the old "Along the way I moved into" read passive, Rob's call): "I worked my way into executive leadership at Trend Micro, Pythian, and Mitel, and learned what it takes to run systems other people depend on."
- Facts rail (definition list, values at body size, never a stat display): 20+ years / Building software · 50+ clinics / Reviewed firsthand · Ottawa, Canada / Based in
- Background rebuilt 2026-08-30 at Rob's direction. Paragraph 1 now carries what happened, in facts Rob supplied that day: "My father was sick for ten years. The system meant to help him kept hurting him instead: sepsis from a catheter, a stent that went wrong, mistake after mistake until he lost his mobility. Watching that is what made healthcare personal for me, before it was ever a business." The professional arc follows (systems architect inside managed health-service organizations, then Dentallytics, then CDAP, family clinics, the attempts, the fifty).
- Zones: Background ("Where healthcare came in." and "Every side of the system.", which replaced "What the failures changed." 2026-08-30 - Rob: it read as thrown in), Caretrics ("Why I believe in Caretrics.", personalized from "Why Caretrics." the same day), Outside ("Outside the work.")
- The ventures untangled 2026-08-30 on Rob's correction (earlier copy, back to the original brief, conflated them): Athlete Builder was an educational platform for youth sports with real customers and an economic model that could not sustain them; the orthopedic care-protocols product was a separate build in a market hard to win and harder to go deep in. The paragraph closes: "Different failures, the same two lessons: stay close to the people doing the work, and test the business before the product."
- The second Background zone closes on the earned claim: "I have been the architect inside the system, the founder selling into it, part of a family that runs clinics in it, and the son it failed. Most people see healthcare from one seat. I have sat in nearly all of them, and that is the experience Caretrics is built on."
- The standard card is full column width as of 2026-08-30 (Rob's call), serif at `--text-serif-quote` (30px, 24 mobile), signature, then "Rob Saric, founder of Caretrics".
- Card quote is THE PAIRING as of 2026-08-30, the canvas's own second option: "People who do good should do well. If what I build adds work to care, it has failed." Creed then test, both Rob's lines, nothing explained (the vision-line rule holds). History: creed alone was his 2026-08-25 pick; he asked the card to carry more on 2026-08-30. The creed still leads the homepage About band body; the test still signs that band and `/how-i-counted/`.
- Outside photo strip, LIVE 2026-08-29 with the design's three slots (O1-O3, 320x213 desktop): the Accelerate OTT shot (`rob-portrait-caretrics.png`, shared with the hero; Rob corrected the event name from "Jane Summit" 2026-08-30), the family group shot (`rob-family-together.jpg`), and the trail shot (`rob-hiking.jpg`). Captions: "Accelerate OTT, 2026" · "Family day at the park" · "On the trail, above the valley". Drafted by Claude at Rob's direction 2026-08-29, written only to what the photos visibly show; Rob's wording overrules anytime (V14 resolved).
...
V13 RESOLVED 2026-08-30, by the person it was flagged for: Rob read the rail's bare "Firsthand" and asked what it meant, which settles the question against the terse split. The term is now "Reviewed firsthand" ("reviewed" is legal where "audited" is banned; the locked components 50+ clinics and firsthand both survive intact).
